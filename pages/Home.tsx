...
import { 
  ArrowRight, ArrowUpRight, CheckCircle2, XCircle, Layers, 
  Settings, BarChart3, AlertCircle, Check, MapPin, Mail, 
  ...
  return (
    <div className="w-full bg-white">
      ...
      <section 
        id="methodology" 
        ref={section4Ref}
        className="relative w-full bg-onyx-black py-32 px-4 md:px-8 lg:px-16"
      >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-end">
               <div className="flex flex-col gap-8">
                  ...
                  <div className="flex flex-col gap-3 mt-8">
                     ...
                     <p className="font-jakarta text-base text-gray-500 pl-7 leading-relaxed max-w-sm">Analizamos la madurez de tu infraestructura actual y definimos la ruta crítica de intervención.</p>
                  </div>
               </div>
               <div className="w-full">
                  <a href="#" className="group relative w-full block bg-white text-black py-8 md:py-12 px-8 overflow-hidden hover:bg-warm-purple transition-colors duration-500">
      ...
      {/* FOOTER */}
      <footer className="relative w-full bg-onyx-black text-white pt-24 pb-8 px-0 border-t border-white/10">
               ...
               <div className="p-8 border-r border-white/10 flex flex-col gap-4 group hover:bg-white/5 transition-colors">
                  ...
                  <div className="flex flex-col gap-2">
                     ...
                     <div className="flex items-center gap-2">
                        ...
                        <span className="font-mono text-sm group-hover:text-warm-purple transition-colors">+502 4318 1439</span>
                     </div>
                  </div>
                  <div className="flex gap-4 pt-2 border-t border-white/10 mt-1">
                     <a href="#" className="text-gray-400 hover:text-warm-purple transition-colors"><Linkedin size={16} /></a>
                     <a href="#" className="text-gray-400 hover:text-warm-purple transition-colors"><Instagram size={16} /></a>
                     <a href="#" className="text-gray-400 hover:text-warm-purple transition-colors"><Facebook size={16} /></a>
                  </div>
               </div>
